(function (z) {
    ...
    var yN = function () {
        function a() {
            ...
            if (!d) {
                d = !0;
                var c = (0, window.$)("#copyright-demo-region1"), f = (0, window.$)("#copyright-demo-region2"), n = (0, window.$)("#copyright-demo-region3"), r = (0, window.$)("#copyright-demo-region4"), w = (0, window.$)("#copyright-demo-indicator");
        ...
        var c = z.GC(z.T[2]).addClass("copyright-demo-noty"), d = !1, f = (0, window.$)((0, window.$)("#copyright-demo-template").html());
    ...
    var zN = function () {
        var a = (0, window.$)('\x3cdiv id\x3d"copyright-demo-helper" style\x3d"display: none; position: absolute;"\x3e\x3cp class\x3d"copyright-demo-helper-intro"\x3e 勾选后，我们将限制其他用户的复制操作，并给予提醒 \x3c/p\x3e\x3cp class\x3d"copyright-demo-helper-btn"\x3e 查看演示 \x3c/p\x3e\x3c/div\x3e'), b = new z.xx({I: "data-copyright-demo"});
        b.Sp = 250;
        b.no = 750;
        b.sh(a[0]);
    ...
    var AO = function (a) {
        ...
        if (b) {
            var c = !Boolean((0, window.$)(".question-page-pager").length), d = void 0, d = c ? new z.Cl({
                    use: ["nodeSource"],
                    Ef: a.data.te > a.data.$T
                }) : new z.Cl({use: [], Ef: !1});
            a.L(d);
    ...
    var YO = function (a) {
        a.$a.on("click", "[data-follow]", function (b) {
            ...
            c.hasClass(a.Kx) ? (b = (0, window.$)(b.target).closest(".topic-item"), a.oA.remove(b[0]), 1 === a.$a.find("." + a.Kx).length && (a.Hq.hasClass("disabled") ? a.nb.fadeOut() : (0, window.setTimeout)(function () {
                        XO(a, 0)
                    })), a.dispatchEvent({type: ZO, data: d})) : c.hasClass(a.FW) && a.dispatchEvent({
                    type: $O,
                    data: d
                })
        })
    ...
    var hP = function (a, b) {
        var c = a.Eq.find(".current").data("feedType"), c = {
            params: {
                topic_id: b,
                feed_type: c
            }
    ...
    var wP = function (a) {
        ...
        var c = (0, window.$)(".pager", a), d = window.$.makeArray((0, window.$)("\x3cdiv\x3e").html((0, window.$)(".js-hidden-list").html()).children().add(b.children())), f = new QO(d, 4);
        f.Hc(function (a) {
    ...
    var zP = function (a) {
        var b = (0, window.$)(".js-choose-image", a.h)[0], c = (0, window.$)(".segment-avatar-wrapper .avatar", a.h), d = new z.Uy(z.Vy), f = void 0;
        d.w(b);
    ...
    var lQ = function () {
        ...
        var b = z.Ba(a, "view_answer", "visit_answer"), c = z.Ba(a, "view_topic", "visit_topic"), d = z.Ba(a, "view_roundtable", "visit_roundtable");
    ...
    gM.prototype.init = function () {
        ...
        if (a) {
            var b = this.gb()[0], c = void 0, c = b ? (0, window.$)(b).data() : z.lh ? {
                        member: z.lh.id,
                        name: z.lh.tF
    ...
    z.e.zS = function () {
        var a = this.hb, b = a.an && a.an.checked, c = Number(!a.iE.checked), a = {
            modal: !0,
            title: "确认放弃匿名身份？",
    ...
    var sQ = "current", gP = "current", cP = ".zm-topic-cat-item", dP = 100, nP = '\x3cli class\x3d"zm-topic-cat-item" data-id\x3d"\x3c%\x3d id %\x3e" data-href\x3d"/topic/\x3c%\x3d url_token %\x3e"\x3e\x3ca href\x3d"#\x3c%\x3d name %\x3e"\x3e\x3c%\x3d name %\x3e\x3c/a\x3e\x3c/li\x3e';
    z.x(oP, z.R);
    ...
    var RP = (0, window.$)("#is-topstory").length ? "topstory2" : "homefeed", JP = z.C && !z.E(9), MP = {
        ac: "actioncard",
        q: "question",
        a: "answer",
        p: "article",
