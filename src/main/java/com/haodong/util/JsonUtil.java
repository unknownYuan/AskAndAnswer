...
public class JsonUtil {
	private static final Set<String> EXCLUDE_METHODS = ImmutableSet.of(
			"getClass", "getDeclaringClass");

	private static final Map<Class<?>, Map<String, Method>> getters = new MapMaker()
			.makeMap();

	/**
	 * Gets a property of an Object. Will return a property value if serializing
	 * the value would produce a JSON object containing that property, otherwise
	 * returns null.
	 */
...
//		} else
	...
	private static String getPropertyName(Method method) {
		...
		if (property == null) {
			...
			if (!EXCLUDE_METHODS.contains(name)) {
